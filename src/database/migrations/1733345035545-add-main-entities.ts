...
export class AddMainEntities1733345035545 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_variant_gallery" ("id" SERIAL NOT NULL, "image" text NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "product_variant_id" integer NOT NULL, CONSTRAINT "PK_fd738ec80bbe5316f0012c21107" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_addresses" ("id" SERIAL NOT NULL, "address_line1" text NOT NULL, "address_line2" text, "phone_number" character varying(255), "country" character varying(255) NOT NULL, "postal_code" character varying(255) NOT NULL, "city" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer NOT NULL, CONSTRAINT "PK_8abbeb5e3239ff7877088ffc25b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" text, "is_root" boolean NOT NULL DEFAULT false, "is_leaf" boolean NOT NULL DEFAULT false, "metadata" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "product_categories" ("id" SERIAL NOT NULL, "product_id" integer, "category_id" integer, CONSTRAINT "PK_7069dac60d88408eca56fdc9e0c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "orders" ("id" SERIAL NOT NULL, "order_delivered_carrier_date" TIMESTAMP, "order_delivered_user_date" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, "order_status_id" integer, "shipping_address_id" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "product_reviews" ("id" SERIAL NOT NULL, "rating" smallint NOT NULL, "review_text" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "product_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_67c1501aea1b0633ec441b00bd5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order_items" ("id" SERIAL NOT NULL, "price" numeric NOT NULL, "quantity" integer NOT NULL, "total" numeric GENERATED ALWAYS AS (price * quantity) STORED NOT NULL, "order_id" integer, "product_variant_id" integer, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "category_parents" ("category_id" integer NOT NULL, "parent_id" integer NOT NULL, CONSTRAINT "PK_17fd9110212734583fbdfd9b262" PRIMARY KEY ("category_id", "parent_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "countries" ("id" SERIAL NOT NULL, "iso" character(2) NOT NULL, "name" character varying(80) NOT NULL, "upper_name" character varying(80) NOT NULL, "iso3" character(3), "num_code" smallint, "phone_code" integer NOT NULL, CONSTRAINT "PK_b2d7006793e8697ab3ae2deff18" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "allowed_attributes" ("id" SERIAL NOT NULL, "name" character varying(256) NOT NULL, "type" character varying(50) NOT NULL, "description" character varying(256), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_6a08af47ae83b372fc97dde19cc" UNIQUE ("name"), CONSTRAINT "PK_732b413eb4ac0ed3f491daa2186" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "category_attributes" ("id" SERIAL NOT NULL, "category_id" integer, "attribute_id" integer, CONSTRAINT "PK_f58b128e30a1ad029b32fb79624" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "carts" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cart_items" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL DEFAULT '1', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "cart_id" integer NOT NULL, "product_id" integer, CONSTRAINT "PK_6fccf5ec03c172d27a28a82928b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "allowed_attribute_values" ("id" SERIAL NOT NULL, "value_string" character varying(256), "value_number" numeric, "range_min" numeric, "range_max" numeric, "color_hex" character varying(10), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "attribute_id" integer NOT NULL, CONSTRAINT "PK_28fc42a3b63382475ed9fe60175" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_variant_gallery" ADD CONSTRAINT "FK_6f6007ae2a91b6454d2f9be966d" FOREIGN KEY ("product_variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_f51b75ebdfdef60d264f982a60f" FOREIGN KEY ("order_status_id") REFERENCES "order_statuses"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_67b8be57fc38bda573d2a8513ec" FOREIGN KEY ("shipping_address_id") REFERENCES "user_addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "category_parents" ADD CONSTRAINT "FK_8e1862c8157087c03c16c4d1a15" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "category_parents" ADD CONSTRAINT "FK_6b5b060c1a4285b256461d87aa3" FOREIGN KEY ("parent_id") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "category_attributes" ADD CONSTRAINT "FK_6730826326fa81ff5511cb0981a" FOREIGN KEY ("attribute_id") REFERENCES "allowed_attributes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "allowed_attribute_values" ADD CONSTRAINT "FK_cc12aaa68449a240d47dc2ffbb8" FOREIGN KEY ("attribute_id") REFERENCES "allowed_attributes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "allowed_attribute_values" DROP CONSTRAINT "FK_cc12aaa68449a240d47dc2ffbb8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "category_attributes" DROP CONSTRAINT "FK_6730826326fa81ff5511cb0981a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "category_attributes" DROP CONSTRAINT "FK_55050a8a1b2d2f5202f226d4ac1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "category_parents" DROP CONSTRAINT "FK_6b5b060c1a4285b256461d87aa3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "category_parents" DROP CONSTRAINT "FK_8e1862c8157087c03c16c4d1a15"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_variant_gallery" DROP CONSTRAINT "FK_6f6007ae2a91b6454d2f9be966d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      ...
      ['GENERATED_COLUMN', 'total', 'shop-co', 'public', 'order_items'],
    );
